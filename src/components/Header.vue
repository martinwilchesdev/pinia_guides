...
<template>
    <header class="text-center pt-20 bg-gray-100 font-poppins">
        <section class="flex justify-center gap-2 text-gray-400">
            <img class="w-14 -rotate-6" src="@/assets/pinia-logo.svg" alt="Pinia Logo">
